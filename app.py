...
# ---------------------------------------------------------------------------
# Barra lateral — filtros del Ranking (persistente en toda la app; el Ranking
# es la vista principal, así que sus filtros viven en la sidebar en vez de
# ocupar espacio horizontal arriba de la tabla).
# ---------------------------------------------------------------------------
with st.sidebar:
    render_html(
...
with tab_ranking:
    ...
    if paises_sel_rank:
        filtro &= rfef["País de nacimiento"].isin(paises_sel_rank)
