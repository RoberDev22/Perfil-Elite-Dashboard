...
# Textos actualizados: sin scores ni logros fijos en el texto (el score real se lee del CSV
# y se muestra dinámicamente en el propio bloque de la tarjeta), para que nunca queden
# desincronizados de los datos del pipeline.
VALIDACION_TEXTO = {
    'Fer López': "Debutó con el primer equipo del Celta tras destacar como mediapunta en la 1ª RFEF.",
    ...
    'Pablo Torre': "Del filial del Mallorca al primer equipo del FC Barcelona con apenas 19 años. Su grupo posicional en esa temporada era muy reducido, por lo que su puesto en el ranking debe interpretarse con cautela.",
    'Jan Virgili': "Progresó en la cantera del Barcelona hasta el primer equipo, confirmando el perfil de extremo finalizador detectado por el sistema.",
    'Pau Víctor': "De la Primera Federación al FC Barcelona, donde debutó en LaLiga como delantero.",
    'Fermín López': "De la Primera Federación (Linares Deportivo) al once titular del FC Barcelona en pocas temporadas.",
    'Victor Muñoz': "Detectado en su temporada de consolidación 2024-25 con el Real Madrid Castilla, como uno de los perfiles de extremo mejor valorados por el sistema.",
}
